...
function SideBar() {
  ...
  const handlePersonalInfoSegmentClick = () => {
    ...
    <div>
      ...
      <div className="sidebar fixed top-0 bottom-0 p-2 w-[300px] z-50 overflow-y-auto text-center bg-black">
        ...
        <div className="overflow-y-auto">
          <div
            className="p-2.5 mt-3 flex items-center justify-between rounded-md px-4 duration-300 cursor-pointer hover:bg-slate-600 text-white"
          ...
          >
            ...
            <svg
              className={`h-6 w-6 fill-current ${isListingExpanded ? "rotate-180" : ""
                }`}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
          ...
          {isListingExpanded && (
            <div className="ml-4">
              ...
              >
                ...
                <span
                  className="text-sm ml-4 text-gray-200 font-bold"
        ...
        <div
          className="p-2.5 mt-3 flex items-center justify-between rounded-md px-4 duration-300 cursor-pointer hover:bg-slate-600 text-white"
          onClick={handlePersonalInfoSegmentClick}
        >
          <div className="flex items-center">
            <svg
              className="h-4 w-8 fill-current"
          ...
          <svg
            className={`h-6 w-6 ml-4 fill-current ${isPersonalInfoExpanded ? "rotate-180" : ""
              }`}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
        ...
        {isPersonalInfoExpanded && (
          <div className="ml-4">
            <div className=" sidebarNotFixed bottom-2 w-[280px]">
              <div
                className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-slate-600 text-white"
